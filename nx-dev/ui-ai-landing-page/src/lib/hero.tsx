...
const aiFeatures: AIFeature[] = [
  ...
  },
  {
    ...
    thumbnailUrl: '/images/ai/codegen-thumb.avif',
          ...
          >
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-xl shadow-2xl">
                <div className="absolute inset-0 z-0 bg-gradient-to-tr from-blue-500/10 to-cyan-500/10"></div>
